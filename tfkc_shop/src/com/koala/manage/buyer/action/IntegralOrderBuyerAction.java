	...
	public void goods_count_adjust(HttpServletRequest request,
		...
		try {
			...
			if (null != user) {
				...
				String sqls = "select a.card_val from tfshop_act_card a where a.card_no=:card_no and a.card_status='0'";
				...
				if (null != list && 0 < list.size()) {
					...
					//更新兑换卡状态
					sqls = "update tfshop_act_card a set a.card_status='1', a.user_id=:userId where a.card_no=:card_no" +
							" and a.card_status='0'";
					pmap.clear();
