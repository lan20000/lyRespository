...
import com.koala.foundation.domain.RoleGroup;
import com.koala.foundation.domain.SysLog;
import com.koala.foundation.domain.User;
import com.koala.foundation.domain.query.SysLogQueryObject;
...
import com.koala.foundation.service.IRoleGroupService;
...
import com.koala.manage.buyer.action.AccountBuyerAction;
import com.koala.manage.buyer.action.AddressBuyerAction;
import com.koala.manage.buyer.action.BaseBuyerAction;
import com.koala.manage.buyer.action.ComplaintBuyerAction;
import com.koala.manage.buyer.action.ConsultBuyerAction;
import com.koala.manage.buyer.action.CouponBuyerAction;
import com.koala.manage.buyer.action.EvaluateBuyerAction;
import com.koala.manage.buyer.action.FavoriteBuyerAction;
import com.koala.manage.buyer.action.FootPointBuyerAction;
import com.koala.manage.buyer.action.FreeBuyerAction;
import com.koala.manage.buyer.action.GroupBuyerAction;
import com.koala.manage.buyer.action.IntegralOrderBuyerAction;
import com.koala.manage.buyer.action.MessageBuyerAction;
import com.koala.manage.buyer.action.OrderBuyerAction;
import com.koala.manage.buyer.action.PredepositBuyerAction;
import com.koala.manage.buyer.action.PredepositCashBuyerAction;
import com.koala.manage.buyer.action.RechargeCardBuyerAction;
import com.koala.manage.delivery.action.DeliveryApplyAction;
import com.koala.manage.delivery.action.DeliveryIndexAction;
import com.koala.manage.seller.action.ActivitySellerAction;
import com.koala.manage.seller.action.AdvertSellerAction;
import com.koala.manage.seller.action.AlbumSellerAction;
import com.koala.manage.seller.action.BaseSellerAction;
import com.koala.manage.seller.action.BuyGiftSellerAction;
import com.koala.manage.seller.action.CombinSellerAction;
import com.koala.manage.seller.action.ComplaintSellerAction;
import com.koala.manage.seller.action.ConsultSellerAction;
import com.koala.manage.seller.action.CouponSellerAction;
import com.koala.manage.seller.action.EnoughReduceSellerAction;
import com.koala.manage.seller.action.EvaluateSellerAction;
import com.koala.manage.seller.action.ExpressCompanyCommonSellerAction;
import com.koala.manage.seller.action.FreeGoodsSellerAction;
import com.koala.manage.seller.action.GoldSellerAction;
import com.koala.manage.seller.action.GoodsBrandSellerAction;
import com.koala.manage.seller.action.GoodsClassSellerAction;
import com.koala.manage.seller.action.GoodsFormatSellerAction;
import com.koala.manage.seller.action.GoodsSellerAction;
import com.koala.manage.seller.action.GoodsSpecSellerAction;
import com.koala.manage.seller.action.GoodsStatSellerAction;
import com.koala.manage.seller.action.GroupSellerAction;
import com.koala.manage.seller.action.OrderSellerAction;
import com.koala.manage.seller.action.PayoffLogsellerAction;
import com.koala.manage.seller.action.ReturnSellerAction;
import com.koala.manage.seller.action.SellerCrmManageAction;
import com.koala.manage.seller.action.ShipAddressSellerAction;
import com.koala.manage.seller.action.SmsSellerAction;
import com.koala.manage.seller.action.StoreAdjustApplyAction;
import com.koala.manage.seller.action.StoreDecorateSellerAction;
import com.koala.manage.seller.action.StoreNavSellerAction;
import com.koala.manage.seller.action.StoreNoticeAction;
import com.koala.manage.seller.action.StoreSellerAction;
import com.koala.manage.seller.action.StoreStatSellerAction;
import com.koala.manage.seller.action.SubAccountSellerAction;
import com.koala.manage.seller.action.TaobaoSellerAction;
import com.koala.manage.seller.action.TransportSellerAction;
import com.koala.manage.seller.action.WaterMarkSellerAction;
import com.koala.manage.seller.action.ZtcSellerAction;
import com.koala.module.app.manage.admin.action.AppManageAction;
import com.koala.module.chatting.manage.admin.action.PlatChattingManageAction;
import com.koala.module.chatting.manage.seller.action.StoreChattingViewAction;
import com.koala.module.sns.manage.admin.action.SnsManageAction;
import com.koala.module.sns.manage.buyer.action.SnsBuyerAction;
import com.koala.module.sns.manage.buyer.action.SnsBuyerDynamicAction;
import com.koala.module.sns.view.action.SnsOtherUserViewAction;
import com.koala.module.sns.view.action.SnsUserShareAction;
import com.koala.module.weixin.manage.admin.action.WeixinManageAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserAddressAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserCenterAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserComplaintAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserFreeAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserGroupAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserGroupInfoAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserIntegralAction;
import com.koala.module.weixin.manage.buyer.action.WeixinUserOrderAction;
import com.koala.module.weixin.view.action.WeixinCartViewAction;
import com.koala.module.weixin.view.action.WeixinFreeGoodsViewAction;
import com.koala.module.weixin.view.action.WeixinGroupViewAction;
import com.koala.module.weixin.view.action.WeixinIntegralViewAction;
import com.koala.view.web.action.CartViewAction;
import com.koala.view.web.action.FreeViewAction;
import com.koala.view.web.action.IntegralViewAction;
import com.koala.view.web.action.RechargeAction;
import com.koala.view.web.action.SellerApplyAction;
