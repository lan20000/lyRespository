...
import com.koala.foundation.domain.virtual.OrderStat;
import com.koala.foundation.domain.virtual.UserStat;
 ...
 */
@Controller
public class SelfGoodsStatAction {
	@Autowired
	...
	@SecurityMapping(title = "商品统计", value = "/admin/self_stat_goods.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "自营")
	@RequestMapping("/admin/self_stat_goods.htm")
	public ModelAndView stat_goods(HttpServletRequest request,
			HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_self_goods.html",
	...
	@SecurityMapping(title = "有信息的商品", value = "/admin/self_stat_goods_list.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "自营")
	@RequestMapping("/admin/self_stat_goods_list.htm")
	public ModelAndView stat_goods_list(HttpServletRequest request,
		...
		if (endTime != null && beginTime != null && !endTime.equals("")
			...
			String hql = "select obj from GoodsLog obj where obj.addTime>=:begin and obj.addTime<=:end  and obj.log_form=0";

			String hql2 = "select  COUNT(*) from GoodsLog obj where obj.addTime>=:begin and obj.addTime<=:end  and obj.log_form=0";
			...
			String url = CommUtil.getURL(request)
					+ "/admin/self_stat_goods_list.htm";
	...
	@SecurityMapping(title = "商品统计结果", value = "/admin/self_stat_goods_done.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "自营")
	@RequestMapping("/admin/self_stat_goods_done.htm")
	...
	@SecurityMapping(title = "全商城统计结果", value = "/admin/self_stat_all.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "自营")
	@RequestMapping("/admin/self_stat_all.htm")
	public ModelAndView stat_all(HttpServletRequest request,
		...
		if (begin != null && end != null) {
			...
			while (!cal.getTime().after(end)) {
				...
				String hql = "select obj from GoodsLog obj where obj.addTime>=:beginDate and obj.addTime<:endDate  and obj.log_form=0";
