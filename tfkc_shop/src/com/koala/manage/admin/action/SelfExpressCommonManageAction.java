...
import com.koala.foundation.domain.query.ExpressCompanyCommonQueryObject;
...
public class SelfExpressCommonManageAction {
	...
	public ModelAndView ecc_save(HttpServletRequest request,
		...
		mv=new JModelAndView("admin/blue/success.html",configService.getSysConfig(),this.userConfigService.getUserConfig(),0,request,response);
