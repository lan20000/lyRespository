...
import com.koala.foundation.domain.query.AdvertPositionQueryObject;
import com.koala.foundation.domain.query.AdvertQueryObject;
...
public class AdvertSellerAction {
	...
	public ModelAndView advert_list(HttpServletRequest request,
		...
		qo.addQuery("obj.ap_sale_type", new SysMap("ap_sale_type", 0), "=");// 非系统广告
		qo.setPageSize(30);
		IPageList pList = this.advertPositionService.list(qo);
		System.out.println("size:" + pList.getResult().size());
	...
	public void advert_vefity(HttpServletRequest request,
			HttpServletResponse response, String day, String ap_id) {
		boolean ret = true;
		AdvertPosition ap = this.advertPositionService.getObjById(CommUtil
				.null2Long(ap_id));
	...
	public void advert_apply_save(HttpServletRequest request,
	...
	public ModelAndView advert_delete(HttpServletRequest request,
			HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView(
	...
	public void advert_delay_save(HttpServletRequest request,
