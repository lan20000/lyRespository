...
import com.koala.core.beans.exception.BeansException;
import com.koala.core.beans.exception.MethodInvocationException;
import com.koala.core.beans.exception.NotReadablePropertyException;
import com.koala.core.beans.exception.NotWritablePropertyException;
import com.koala.core.beans.exception.NullValueInNestedPathException;
import com.koala.core.beans.exception.PropertyException;
import com.koala.core.beans.exception.TypeMismatchException;
	...
	private void setPropertyValue(PropertyTokenHolder tokens, Object newValue) throws BeansException {
		...
		if (tokens.keys != null) {
			...
			try {				
				...
				if(newValue!=null && newValue.getClass().getSimpleName().indexOf("$$Enhancer")>0)isProx=true;
				//增加对CGLIB增强的判断，凡是增强后的类型都不进行延迟加载
				Object convertedValue = isProx?newValue:this.typeConverterDelegate.convertIfNecessary(oldValue, newValue, pd);
