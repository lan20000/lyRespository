...
class TypeConverter {
	...
	/**
	 * Create a new TypeConverterDelegate for the given editor registry and bean
	 * instance.
	 * 
	 * @param propertyEditorRegistry
	 *            the editor registry to use
	 * @param targetObject
	 *            the target object to work on (as context that can be passed to
	 *            editors)
	 */
	public TypeConverter(PropertyEditorRegistry propertyEditorRegistry,
			Object targetObject) {
	...
	protected Object convertIfNecessary(String propertyName, Object oldValue,
		...
		if (pe != null
			...
			if (pe == null && requiredType != null) {
				...
				pe = (PropertyEditor) this.propertyEditorRegistry
	...
	protected Collection convertToTypedCollection(Collection original,
		...
		if (methodParam != null
				&& JdkVersion.getJavaVersion() >= JdkVersion.JDK_1_5) {
