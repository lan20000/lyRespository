package com.koala.core.security.support;
 ...
 * 
 * <p>
 * Title: ShopSecurityExceptionFilter.java
 * </p>
 * 
 * <p>
 * Description: 重写SpringSecurity异常过滤器，为了解决超级管理后台和普通会员后台无权限操作的不同导向，
 * 该类重新为了配合ShopAccessDeniedHandlerImpl使用
 * ，仅仅在构造函数中完成ShopAccessDeniedHandlerImpl的初始化工作即可
 * </p>
 * 
 * <p>
