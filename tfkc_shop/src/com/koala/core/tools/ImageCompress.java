 ...
 * 
 * <p>
 * Description: 图片压缩算法,c2c V1.3开始使用，B2B2C V1.0开始使用，生成等比例高清图片
 * </p>
 * 
 * <p>
...
public class ImageCompress extends Frame {
	...
	public static void main(String[] args) {
		...
		if (gui.equals("gui")) {
			...
			ImageCompress.ImageScale(fileName,
					fileName + "-s." + getFileExt(fileName).toLowerCase(), 160,
					160);
	...
	public static void ImageScale1(String sourceImg, String targetImg,
	 ...
	 * @param outputHeight
	 */
	 public static void ImageScale(String fromFile, String toFile, int outputWidth, int outputHeight) {
		 try {  
