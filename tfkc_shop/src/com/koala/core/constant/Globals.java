package com.koala.core.constant;
...
public class Globals {
	public final static String DEFAULT_SYSTEM_TITLE = "koala B2B2C商城系统";// 系统默认名称
	...
	public final static String DEFAULT_WBESITE_NAME = "koala";// 软件名称
	...
	public final static String DEFAULT_TABLE_SUFFIX = "tfshop_";// 默认表前缀名
