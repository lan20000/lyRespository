...
public class IPSeeker {
	...
	// 保存的文件夹
	private String INSTALL_DIR = System.getProperty("koalab2b2c.root")
	...
	public IPSeeker(String fileName, String dir) {
		...
		b3 = new byte[3];
		try {
			// System.out.println("============================="+INSTALL_DIR+File.separator+IP_FILE);
			ipFile = new RandomAccessFile(INSTALL_DIR + File.separator
					+ IP_FILE, "r");
		...
		if (ipFile != null) {
			try {
				...
				LogFactory.log("IP地址信息文件格式有错误，IP显示功能将无法使用", Level.ALL, e);
				ipFile = null;
			}
		}
	}
