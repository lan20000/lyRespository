...
import com.koala.core.service.IQueryService;
import com.koala.core.tools.CommUtil;
import com.koala.core.weixin.pojo.WeixinAccessToken;
import com.koala.core.weixin.pojo.WeixinOauth2Token;
import com.koala.core.weixin.utils.AdvancedUtil;
import com.koala.core.weixin.utils.CommonUtil;
import com.koala.core.weixin.utils.PayCommonUtil;
import com.koala.core.weixin.utils.WeixinUtil;
import com.koala.foundation.dao.FreeApplyLogDAO;
import com.koala.foundation.dao.GroupJoinerDAO;
import com.koala.foundation.domain.Accessory;
import com.koala.foundation.domain.Activity;
...
import com.koala.foundation.domain.GoodsCart;
...
import com.koala.foundation.domain.GroupJoiner;
...
import com.koala.foundation.domain.StoreStat;
...
import com.koala.foundation.service.IGroupJoinerService;
...
import com.koala.manage.admin.tools.StatTools;
import com.koala.module.app.domain.AppPushLog;
import com.koala.module.app.service.IAppPushLogService;
import com.koala.module.app.view.tools.AppPushTools;
...
public class SysConfigService implements ISysConfigService {
	...
	public void runTimerByDay() {
		...
		for (GroupLifeGoods group : groups) {
			...
			// 删除索引
			String goodslife_lucene_path = System.getProperty("koalab2b2c.root")
		...
		for (GroupGoods group : groupgoodes) {
			...
			for (Goods goods : goods_list) {// 团购过期，将商品还原
				...
				this.goodsDAO.update(goods);
				// 删除索引
				String goodsgroup_lucene_path = System.getProperty("koalab2b2c.root")
...
//		+ "(SELECT y.child_group_id, x.gg_group_count from tfshop_group_goods x, tfshop_group_joiner y where x.id=y.rela_group_goods_id "
...
//		+ "tfshop_group_joiner b, tfshop_orderform c  where a.child_group_id=b.child_group_id "
//		+ "and b.rela_order_form_id=c.id and b.status='1'";
		
		String sql = "SELECT b.child_group_id, a.gg_group_count, b.joiner_count from tfshop_group_goods a," +
				" tfshop_group_joiner b where a.id=b.rela_group_goods_id and b.is_group_creator='1' " +
