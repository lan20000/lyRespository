package com.koala.foundation.log;
...
import com.koala.foundation.domain.LogFieldType;
...
public class SystemLogAdvice {
	...
	// 记录管理员操作日志
	@After(value = "execution(* com.koala.manage.admin..*.*(..)) && @annotation(annotation)&&args(request,..)")
	...
	@After(value = "execution(* com.koala.module.weixin.manage..*.*(..)) && @annotation(annotation)&&args(request,..)")
	...
	@After(value = "execution(* com.koala.module.app.manage..*.*(..)) && @annotation(annotation)&&args(request,..)")
	...
	@After(value = "execution(* com.koala.module.cms.manage..*.*(..)) && @annotation(annotation)&&args(request,..)")
	...
	@After(value = "execution(* com.koala.module.circle.manage..*.*(..)) && @annotation(annotation)&&args(request,..)")
	...
	@After(value = "execution(* com.koala.module.sns.manage..*.*(..)) && @annotation(annotation)&&args(request,..)")
	...
	// 异常日志记录
	@AfterThrowing(value = "execution(* com.koala.manage.admin..*.*(..))&&args(request,..) ", throwing = "exception")
