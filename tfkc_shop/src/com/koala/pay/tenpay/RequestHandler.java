...
public class RequestHandler {
	 ...
	 * 创建md5摘要,规则是:按参数名称a-z排序,遇到空值的参数不参加签名。
	 */
	public String createSign(SortedMap<String, String> packageParams,String skey) {
		StringBuffer sb = new StringBuffer();
	...
	// 获取package的签名包
		public String genPackage(SortedMap<String, String> packageParams,String paykey)
				throws UnsupportedEncodingException {
			String sign = createSign(packageParams,paykey);
